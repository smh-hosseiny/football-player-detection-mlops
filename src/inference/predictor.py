...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default='../models/best.pt', help="Path to .pt model weights")
    parser.add_argument("--device", default="cuda", help="Device for inference ('cuda' or 'cpu')")
    parser.add_argument("--conf", type=float, default=0.25, help="Confidence threshold")
    parser.add_argument("--save_path", default=None, help="Path to save output (image or video, optional)")
